...
const StripeStyleDocs = () => {
  ...
  const renderContent = () => {
    ...
    if (activePage === 'introduction') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Introduction</h1>
          ...
          <div className="bg-[var(--secondary)]/10 border-l-4 border-[var(--secondary)] p-4 my-6">
            <p className="text-[var(--secondary)] font-medium mb-2">API Vision</p>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">What is Emotional Intelligence in API Form?</h2>
          ...
          <ul className="list-disc ml-6 text-[var(--text)] mb-6">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Who Should Use the Kindred AI API?</h2>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Core Capabilities</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="border border-[var(--border)] rounded-lg p-4">
              <h3 className="text-lg font-medium text-[var(--primary)] mb-2">Conversation Intelligence</h3>
              <p className="text-[var(--textSecondary)]">Advanced AI for emotionally aware conversations that adapt to user feelings and needs.</p>
            </div>
            
            <div className="border border-[var(--border)] rounded-lg p-4">
              <h3 className="text-lg font-medium text-[var(--primary)] mb-2">Sentiment Analysis</h3>
              <p className="text-[var(--textSecondary)]">Real-time analysis of emotional content in text and voice interactions.</p>
            </div>
            
            <div className="border border-[var(--border)] rounded-lg p-4">
              <h3 className="text-lg font-medium text-[var(--primary)] mb-2">EQ Assessment</h3>
              <p className="text-[var(--textSecondary)]">Standardized testing and evaluation of emotional intelligence capabilities.</p>
            </div>
            
            <div className="border border-[var(--border)] rounded-lg p-4">
              <h3 className="text-lg font-medium text-[var(--primary)] mb-2">Growth Tracking</h3>
              <p className="text-[var(--textSecondary)]">Monitoring and visualizing emotional intelligence development over time.</p>
            </div>
          </div>
          
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Getting Started</h2>
          ...
          <ol className="list-decimal ml-6 mb-8">
            <li className="mb-3">
              <strong>Register for an API key</strong> - Sign up at our <a href="#" className="text-[var(--primary)] hover:text-[var(--activeNavText)]">Developer Dashboard</a>
            </li>
            <li className="mb-3">
              <strong>Authenticate your requests</strong> - See our <span className="text-[var(--primary)] font-medium cursor-pointer" onClick={() => setActivePage('authentication')}>Authentication guide</span>
            </li>
            <li className="mb-3">
              <strong>Choose your integration</strong> - Explore our <span className="text-[var(--primary)] font-medium cursor-pointer" onClick={() => setActivePage('conversation-api')}>AI Assistant APIs</span> or 
              <span className="text-[var(--primary)] font-medium cursor-pointer" onClick={() => setActivePage('eq-assessment')}> EQ Assessment tools</span>
            </li>
            <li className="mb-3">
              <strong>Implement and test</strong> - Use our <span className="text-[var(--primary)] font-medium cursor-pointer" onClick={() => setActivePage('api-playground')}>API Playground</span> to test your integration
            </li>
          </ol>
        </div>
      );
    ...
    if (activePage === 'authentication') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Authentication</h1>
          ...
          <p className="mb-4">
            Test mode secret keys have the prefix <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">sk_test_</code>, and live mode secret
            keys have the prefix <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">sk_live_</code>. Alternatively, you can use restricted
            API keys for granular permissions.
          </p>
          
          <div className="bg-[var(--secondary)]/10 border-l-4 border-[var(--secondary)] p-4 my-6">
            <p className="text-[var(--secondary)] font-medium mb-2">Always keep your secret keys secure!</p>
            <p className="text-[var(--text)]">Do not share your secret API keys in publicly accessible areas such as
            GitHub, client-side code, and so forth.</p>
          </div>
          
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Authentication to the API</h2>
          ...
          <p className="mb-4">
            ...
            request), use <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">-H "Authorization: Bearer sk_test_abc123..."</code> instead of
            <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">-u sk_test_abc123:</code>.
          </p>
    ...
    if (activePage === 'errors') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Errors & Responses</h1>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">HTTP Status Codes</h2>
          
          <div className="overflow-x-auto mb-6">
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Status Code</th>
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Description</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[var(--border)]">
                <tr>
                  ...
                  <td className="py-3 px-4 text-sm text-[var(--textSecondary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Error Response Format</h2>
          ...
          <div className="bg-[var(--hoverNav)] p-4 rounded-md mb-6">
            <pre className="text-sm text-[var(--text)]">
          {`{
            "error": {
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Error Attributes</h2>
          
          <div className="overflow-x-auto mb-6">
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Attribute</th>
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Description</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[var(--border)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Handling Errors</h2>
    ...
    if (activePage === 'versioning') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">API Versioning</h1>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Current Version</h2>
          
          <p className="mb-4">
            The current version of the Kindred AI Hub API is <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">v1</code>.
            All API requests should be made to endpoints starting with:
          </p>
          
          <div className="bg-[var(--hoverNav)] p-4 rounded-md mb-6">
            <code className="text-md text-[var(--activeNavText)]">https://api.kindredai.com/v1/</code>
          </div>
          
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Version Changes</h2>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Deprecation Policy</h2>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">API Changelog</p>
            <p className="text-[var(--primary)]">
              You can view our complete <span className="text-[var(--primary)] font-medium cursor-pointer" onClick={() => setActivePage('changelog')}>API changelog</span> to
              stay up to date with all new features, improvements, and deprecations.
            </p>
          </div>
          
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Version Lifecycle</h2>
          
          <div className="overflow-x-auto mb-6">
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Status</th>
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Description</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[var(--border)]">
                <tr>
                  <td className="py-3 px-4 text-sm text-[var(--text)]">
                    <span className="font-semibold text-[var(--secondary)]">Current</span>
                  </td>
                  <td className="py-3 px-4 text-sm text-[var(--textSecondary)]">
                ...
                <tr>
                  <td className="py-3 px-4 text-sm text-[var(--text)]">
                    <span className="font-semibold text-[var(--secondary)]">Maintained</span>
                  </td>
                  <td className="py-3 px-4 text-sm text-[var(--textSecondary)]">
                ...
                <tr>
                  <td className="py-3 px-4 text-sm text-[var(--text)]">
                    <span className="font-semibold text-[var(--secondary)]">Deprecated</span>
                  </td>
                  <td className="py-3 px-4 text-sm text-[var(--textSecondary)]">
                ...
                <tr>
                  <td className="py-3 px-4 text-sm text-[var(--text)]">
                    <span className="font-semibold text-[var(--secondary)]">Retired</span>
                  </td>
                  <td className="py-3 px-4 text-sm text-[var(--textSecondary)]">
    ...
    if (activePage === 'rate-limits') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Rate Limits</h1>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Current Rate Limits</h2>
          
          <div className="overflow-x-auto mb-6">
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Plan</th>
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">API Requests</th>
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Emotional Analysis Requests</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[var(--border)]">
                <tr>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Rate Limit Response</h2>
          
          <p className="mb-4">
            When you exceed the rate limit, the API will return a <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">429 Too Many Requests</code> response
          ...
          <div className="overflow-x-auto mb-6">
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Header</th>
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Description</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[var(--border)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Best Practices for Rate Limits</h2>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Need Higher Limits?</p>
            <p className="text-[var(--primary)]">
              If your application requires higher rate limits, please consider upgrading your plan or 
              <a href="#" className="text-[var(--primary)] hover:text-[var(--activeNavText)]"> contact our sales team</a> for custom enterprise solutions.
            </p>
          </div>
        </div>
      );
    ...
    if (activePage === 'request-ids') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Request IDs & Metadata</h1>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Request IDs</h2>
          
          <p className="mb-4">
            All API responses include a <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">request_id</code> in both the headers and the response body (for error responses).
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Metadata</h2>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Metadata Guidelines</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Idempotency Keys</h2>
          ...
          <p className="mb-4">
            ...
            timeouts. Include the key in the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">Idempotency-Key</code> header.
          </p>
    ...
    if (activePage === 'conversation-api') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Conversation API</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Key Capabilities</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Available Endpoints</h2>
          
          <div className="overflow-x-auto mb-6">
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Endpoint</th>
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Description</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[var(--border)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Sending a Message</h2>
          
          <p className="mb-4">
            To send a message to the AI and get a response, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">POST /v1/conversation/send</code> endpoint.
            This allows your application to exchange messages with the Kindred AI system.
          </p>
          
          <h3 className="text-lg font-semibold text-[var(--text)] mt-6 mb-3">Required Parameters</h3>
          
          <div className="overflow-x-auto mb-6">
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Parameter</th>
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Type</th>
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Description</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[var(--border)]">
          ...
          <h3 className="text-lg font-semibold text-[var(--text)] mt-6 mb-3">Optional Parameters</h3>
          ...
          <h3 className="text-lg font-semibold text-[var(--text)] mt-6 mb-3">Response Format</h3>
    ...
    if (activePage === 'user-context') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">User Context</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Why Context Matters</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Creating or Updating User Context</h2>
          
          <p className="mb-4">
            To provide or update context for a user, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">POST /v1/user/context</code> endpoint.
          ...
          <h3 className="text-lg font-semibold text-[var(--text)] mt-6 mb-3">Optional Context Fields</h3>
          
          <div className="overflow-x-auto mb-6">
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Field</th>
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Type</th>
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Description</th>
                </tr>
              </thead>
          ...
          <h3 className="text-lg font-semibold text-[var(--text)] mt-6 mb-3">Best Practices</h3>
    ...
    if (activePage === 'sentiment-analysis') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Sentiment Analysis</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Powerful Emotional Analysis</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Analyzing Emotions</h2>
          
          <p className="mb-4">
            To analyze text for emotional content, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">POST /v1/analysis/sentiment</code> endpoint.
          </p>
          ...
          <h3 className="text-lg font-semibold text-[var(--text)] mt-6 mb-3">Response Structure</h3>
          ...
          <h3 className="text-lg font-semibold text-[var(--text)] mt-6 mb-3">Response Fields</h3>
    ...
    if (activePage === 'response-customization') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Response Customization</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Flexible Persona Design</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Creating a Custom Response Profile</h2>
          
          <p className="mb-4">
            To create a customized response profile, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">POST /v1/conversation/customize</code> endpoint.
          ...
          <h3 className="text-lg font-semibold text-[var(--text)] mt-6 mb-3">Response</h3>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Using a Custom Profile</h2>
          
          <p className="mb-4">
            To use a custom response profile with the Conversation API, include the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">profile_id</code>
    ...
    if (activePage === 'real-time-coaching') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Real-Time Coaching</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Live Guidance</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Analyzing Text for Coaching</h2>
          
          <p className="mb-4">
            To get coaching feedback on text, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">POST /v1/coaching/analyze</code> endpoint.
    ...
    if (activePage === 'eq-assessment') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">EQ Assessment</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Research-Backed Assessments</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Creating an Assessment</h2>
          
          <p className="mb-4">
            To start a new EQ assessment, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">POST /v1/eq/assessment/create</code> endpoint.
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Submitting Assessment Responses</h2>
          
          <p className="mb-4">
            Once the user has completed the assessment, submit their responses using the 
            <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]"> POST /v1/eq/assessment/submit</code> endpoint.
          </p>
    ...
    if (activePage === 'self-awareness') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Self-Awareness & Management</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Inner Emotional Intelligence</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Getting Self-Awareness Insights</h2>
          
          <p className="mb-4">
            To retrieve personalized insights for a user, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">{`GET /v1/eq/self/insights/{user_id}`}</code> endpoint.
            This provides custom insights based on the user's assessment results and emotional logs.
          </p>
          
          <h3 className="text-lg font-semibold text-[var(--text)] mt-6 mb-3">Parameters</h3>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Logging Emotional Experiences</h2>
          
          <p className="mb-4">
            Users can log their emotional experiences using the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">POST /v1/eq/self/log</code> endpoint.
    ...
    if (activePage === 'social-awareness') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Social Awareness & Relationship Management</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Interpersonal Emotional Intelligence</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Getting Social Awareness Insights</h2>
          
          <p className="mb-4">
            To retrieve social intelligence insights for a user, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">{`GET /v1/eq/social/insights/{user_id}`}</code> endpoint.
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Generating Social Scenarios</h2>
          
          <p className="mb-4">
            To create realistic social scenarios for practice and development, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">POST /v1/eq/social/scenario</code> endpoint.
          </p>
    ...
    if (activePage === 'emotion-tracking') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Emotion Tracking</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Emotional Analytics</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Logging Emotions</h2>
          
          <p className="mb-4">
            To log an emotional state or event, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">POST /v1/eq/tracking/log</code> endpoint.
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Analyzing Emotional Trends</h2>
          
          <p className="mb-4">
            To analyze a user's emotional patterns over time, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">{`GET /v1/eq/tracking/trends/{user_id}`}</code> endpoint.
    ...
    if (activePage === 'team-leadership') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Team & Leadership Insights</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Organizational EQ</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Team EQ Analysis</h2>
          
          <p className="mb-4">
            To get an emotional intelligence analysis for a team, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">{`GET /v1/eq/team/analysis/{team_id}`}</code> endpoint.
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Leadership EQ Insights</h2>
          
          <p className="mb-4">
            To get leadership-focused emotional intelligence insights for a user, use the 
            <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">{`GET /v1/eq/leadership/insights/{user_id}`}</code> endpoint.
    ...
    if (activePage === 'data-dashboards') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Data Dashboards</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Visual EQ Analytics</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Getting User Dashboard Data</h2>
          
          <p className="mb-4">
            To retrieve dashboard data for a specific user, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">{`GET /v1/dashboard/user/{user_id}`}</code> endpoint.
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Getting Embed Code</h2>
          
          <p className="mb-4">
            To get embed code for including a dashboard in your application, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">{`GET /v1/dashboard/embed/{dashboard_id}`}</code> endpoint.
    ...
    if (activePage === 'integrations') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Integrations</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Connected Ecosystem</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Supported Integrations</h2>
          
          <div className="overflow-x-auto mb-6">
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Platform</th>
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Features</th>
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Status</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[var(--border)]">
                ...
                <tr>
                  ...
                  <td className="py-3 px-4 text-sm text-[var(--textSecondary)]">
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[var(--secondary)]/20 text-[var(--secondary)]">
                      Coming Soon
                    </span>
                  </td>
                </tr>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Connecting an Integration</h2>
          
          <p className="mb-4">
            To connect a new integration, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">POST /v1/integrations/connect</code> endpoint.
    ...
    if (activePage === 'webhooks') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Webhooks</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Event-Driven Architecture</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Supported Events</h2>
          
          <div className="overflow-x-auto mb-6">
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Event Type</th>
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Description</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[var(--border)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Creating a Webhook</h2>
          
          <p className="mb-4">
            To create a new webhook endpoint, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">POST /v1/webhooks</code> endpoint.
    ...
    if (activePage === 'settings') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Customization & Settings</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Personalized Experience</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Configurable Settings</h2>
          
          <div className="overflow-x-auto mb-6">
            <table className="min-w-full border-collapse">
              <thead>
                <tr className="border-b border-[var(--border)]">
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Setting Category</th>
                  <th className="py-3 px-4 text-left text-sm font-semibold text-[var(--textSecondary)]">Configurable Options</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[var(--border)]">
                <tr>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Updating Settings</h2>
          
          <p className="mb-4">
            To update configuration settings, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">PATCH /v1/settings</code> endpoint.
            This allows you to modify various aspects of how Kindred AI Hub works.
          </p>
          
          <h3 className="text-lg font-semibold text-[var(--text)] mt-6 mb-3">Request Example</h3>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Branding Customization</h2>
          
          <p className="mb-4">
            To update branding settings, use the <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">POST /v1/settings/branding</code> endpoint.
    ...
    if (activePage === 'medchefs') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">MedChefs API</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Under Development</p>
            <p className="text-[var(--primary)]">
    ...
    if (activePage === 'goleman') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Goleman AI API</h1>
    ...
    if (activePage === 'waitingroom') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">WaitingRoom API</h1>
    ...
    if (activePage === 'api-playground') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">API Playground</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Interactive Testing</p>
            <p className="text-[var(--primary)]">
              The playground is available in the <a href="#" className="text-[var(--primary)] hover:text-[var(--activeNavText)]">Kindred AI Developer Dashboard</a>.
              You'll need to sign in with your developer account to access it.
            </p>
          </div>
          
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Playground Features</h2>
          ...
          <div className="bg-[var(--hoverNav)] p-4 rounded-md mb-6">
            <h3 className="text-md font-semibold text-[var(--text)] mb-2">API Playground Preview</h3>
            <p className="text-[var(--textSecondary)] mb-4">The actual playground is available in the Developer Dashboard. Here's what you can expect to see:</p>
            <div className="border border-[var(--border)] rounded-md overflow-hidden">
              <div className="bg-[var(--codeBackground)] p-2 text-[var(--text)] text-sm font-medium">
                API Playground - Emotion Analysis Endpoint
              </div>
              <div className="grid grid-cols-2 divide-x divide-[var(--border)]">
                <div className="p-4 bg-[var(--sidebar)]">
                  <h4 className="text-sm font-semibold text-[var(--text)] mb-2">Request</h4>
                  <div className="mb-3">
                    <label className="block text-xs text-[var(--textSecondary)] mb-1">Endpoint</label>
                    <div className="flex">
                      <span className="bg-[var(--hoverNav)] text-[var(--textSecondary)] px-2 py-1 rounded-l-md border border-[var(--border)] text-xs">POST</span>
                      <input type="text" value="/v1/analysis/sentiment" readOnly className="flex-1 px-2 py-1 text-xs border border-l-0 border-[var(--border)] rounded-r-md bg-[var(--sidebar)]" />
                    </div>
                  </div>
                  <div className="mb-3">
                    <label className="block text-xs text-[var(--textSecondary)] mb-1">Parameters</label>
                    <div className="bg-[var(--sidebar)] p-2 rounded-md border border-[var(--border)] text-xs font-mono">
                      {"{"}
                      <br />
                  ...
                  <button className="bg-[var(--primary)] hover:bg-[var(--primary)]/80 text-[var(--text)] text-xs py-1 px-3 rounded">
                    Send Request
                  </button>
                </div>
                <div className="p-4 bg-[var(--sidebar)]">
                  <h4 className="text-sm font-semibold text-[var(--text)] mb-2">Response</h4>
                  <div className="bg-[var(--codeBackground)] p-2 rounded-md text-xs font-mono text-[var(--secondary)] overflow-auto h-40">
                    {"{"}
                    <br />
    ...
    if (activePage === 'sdks') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">SDKs & Client Libraries</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Language-Native Integration</p>
            <p className="text-[var(--primary)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Available SDKs</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="border border-[var(--border)] rounded-lg p-4">
              <h3 className="text-lg font-medium text-[var(--text)] mb-2">Python</h3>
              <p className="text-[var(--textSecondary)] mb-3">Ideal for data science, backend services, and script automation.</p>
              
              <div className="bg-[var(--codeBackground)] p-3 rounded-md text-sm mb-3">
                <code className="text-[var(--codeText)]">pip install kindred-ai</code>
              </div>
              
              <div className="flex justify-between">
                <a href="#" className="text-[var(--primary)] hover:text-[var(--activeNavText)] text-sm">Documentation</a>
                <a href="#" className="text-[var(--primary)] hover:text-[var(--activeNavText)] text-sm">GitHub</a>
              </div>
            </div>
            
            <div className="border border-[var(--border)] rounded-lg p-4">
              <h3 className="text-lg font-medium text-[var(--text)] mb-2">JavaScript</h3>
              <p className="text-[var(--textSecondary)] mb-3">For web applications, Node.js backends, and browser integrations.</p>
              
              <div className="bg-[var(--codeBackground)] p-3 rounded-md text-sm mb-3">
                <code className="text-[var(--codeText)]">npm install @kindredai/sdk</code>
              </div>
            ...
            <div className="border border-[var(--border)] rounded-lg p-4">
              <h3 className="text-lg font-medium text-[var(--text)] mb-2">Java</h3>
              <p className="text-[var(--textSecondary)] mb-3">For enterprise applications, Android development, and Spring backends.</p>
              
              <div className="bg-[var(--codeBackground)] p-3 rounded-md text-sm mb-3">
                <code className="text-[var(--codeText)]">
                  &lt;dependency&gt;<br/>
            ...
            <div className="border border-[var(--border)] rounded-lg p-4">
              <h3 className="text-lg font-medium text-[var(--text)] mb-2">Ruby</h3>
              <p className="text-[var(--textSecondary)] mb-3">For Ruby on Rails applications and script automation.</p>
              
              <div className="bg-[var(--codeBackground)] p-3 rounded-md text-sm mb-3">
                <code className="text-[var(--codeText)]">gem install kindred-ai</code>
              </div>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Coming Soon</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="border border-[var(--border)] rounded-lg p-3 bg-[var(--sidebar)]">
              <h3 className="text-md font-medium text-[var(--text)] mb-1">PHP</h3>
              <p className="text-[var(--textSecondary)] text-sm">Expected Q2 2025</p>
            </div>
            
            <div className="border border-[var(--border)] rounded-lg p-3 bg-[var(--sidebar)]">
              <h3 className="text-md font-medium text-[var(--text)] mb-1">Go</h3>
              <p className="text-[var(--textSecondary)] text-sm">Expected Q2 2025</p>
            </div>
            
            <div className="border border-[var(--border)] rounded-lg p-3 bg-[var(--sidebar)]">
              <h3 className="text-md font-medium text-[var(--text)] mb-1">.NET</h3>
              <p className="text-[var(--textSecondary)] text-sm">Expected Q3 2025</p>
            </div>
          </div>
          
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">SDK Example: Python</h2>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">SDK Example: JavaScript</h2>
    ...
    if (activePage === 'code-examples') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Code Examples</h1>
          ...
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Learning Resources</p>
            <p className="text-[var(--primary)]">
              For more comprehensive examples and tutorials, check out our 
              <a href="#" className="text-[var(--primary)] hover:text-[var(--activeNavText)]"> GitHub repository</a> and 
              <a href="#" className="text-[var(--primary)] hover:text-[var(--activeNavText)]"> developer blog</a>.
            </p>
          </div>
          
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Authenticating with the API</h2>
          
          <div className="mb-6">
            <div className="flex space-x-1 border-b">
              <button className="px-4 py-2 text-sm font-medium text-[var(--textSecondary)] hover:text-[var(--primary)] focus:outline-none">Python</button>
              <button className="px-4 py-2 text-sm font-medium text-[var(--textSecondary)] hover:text-[var(--primary)] focus:outline-none">JavaScript</button>
              <button className="px-4 py-2 text-sm font-medium text-[var(--primary)] border-b-2 border-purple-600 focus:outline-none">cURL</button>
            </div>
            
            <div className="bg-[var(--hoverNav)] p-4 rounded-b-md">
              <pre className="text-sm text-[var(--text)]">
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Analyzing Text for Emotions</h2>
          
          <div className="mb-6">
            <div className="flex space-x-1 border-b">
              <button className="px-4 py-2 text-sm font-medium text-[var(--primary)] border-b-2 border-purple-600 focus:outline-none">Python</button>
              <button className="px-4 py-2 text-sm font-medium text-[var(--textSecondary)] hover:text-[var(--primary)] focus:outline-none">JavaScript</button>
              <button className="px-4 py-2 text-sm font-medium text-[var(--textSecondary)] hover:text-[var(--primary)] focus:outline-none">cURL</button>
            </div>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Creating and Submitting an EQ Assessment</h2>
          
          <div className="mb-6">
            <div className="flex space-x-1 border-b">
              <button className="px-4 py-2 text-sm font-medium text-[var(--textSecondary)] hover:text-[var(--primary)] focus:outline-none">Python</button>
              <button className="px-4 py-2 text-sm font-medium text-[var(--primary)] border-b-2 border-purple-600 focus:outline-none">JavaScript</button>
              <button className="px-4 py-2 text-sm font-medium text-[var(--textSecondary)] hover:text-[var(--primary)] focus:outline-none">cURL</button>
            </div>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Tracking Emotions Over Time</h2>
          ...
          <h2 className="text-xl font-semibold text-[var(--text)] mt-8 mb-4">Setting Up a Webhook</h2>
    ...
    if (activePage === 'changelog') {
      return (
        <div className="py-6">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-6">Changelog</h1>
          
          <p className="mb-4">
            The changelog tracks all notable changes to the Kindred AI Hub API. We follow 
            <a href="https://semver.org/" className="text-[var(--primary)] hover:text-[var(--activeNavText)]"> Semantic Versioning</a> for 
            our API versions and provide detailed information about new features, improvements, and bug fixes.
          </p>
          
          <div className="bg-[var(--primary)]/10 border-l-4 border-[var(--primary)] p-4 my-6">
            <p className="text-[var(--primary)] font-medium mb-2">Stay Up to Date</p>
            <p className="text-[var(--primary)]">
              Subscribe to our <a href="#" className="text-[var(--primary)] hover:text-[var(--activeNavText)]">developer newsletter</a> to 
              receive notifications about API updates, new features, and changes.
            </p>
          </div>
          
          <div className="border-l-2 border-[var(--border)] pl-5 py-2 mb-8">
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-[var(--text)] mb-2">
                <span className="px-2 py-1 rounded-full text-sm font-medium bg-[var(--secondary)]/10 text-[var(--secondary)] mr-2">v1.3.0</span>
                February 1, 2025
              </h2>
              
              <h3 className="text-lg font-medium text-[var(--text)] mt-4 mb-2">
                <span className="text-[var(--primary)] mr-1">✨</span> New Features
              </h3>
              <ul className="list-disc ml-6 text-[var(--text)] mb-4">
                <li className="mb-1">Added new <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">team.analysis.completed</code> webhook event</li>
                <li className="mb-1">Introduced batch processing for sentiment analysis with the new <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">POST /v1/analysis/sentiment/batch</code> endpoint</li>
                <li className="mb-1">Added support for custom branding in embedded dashboards</li>
              </ul>
              
              <h3 className="text-lg font-medium text-[var(--text)] mt-4 mb-2">
                <span className="text-[var(--primary)] mr-1">🛠️</span> Improvements
              </h3>
              <ul className="list-disc ml-6 text-[var(--text)] mb-4">
              ...
              <h3 className="text-lg font-medium text-[var(--text)] mt-4 mb-2">
                <span className="text-[var(--secondary)] mr-1">🐛</span> Bug Fixes
              </h3>
            ...
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-[var(--text)] mb-2">
                <span className="px-2 py-1 rounded-full text-sm font-medium bg-[var(--secondary)]/10 text-[var(--secondary)] mr-2">v1.2.0</span>
                January 15, 2025
              </h2>
              ...
              <ul className="list-disc ml-6 text-[var(--text)] mb-4">
                <li className="mb-1">Added team analysis capabilities with the new <code className="bg-[var(--hoverNav)] px-1 py-0.5 rounded text-[var(--activeNavText)]">/v1/eq/team</code> endpoints</li>
            ...
            <div>
              <h2 className="text-xl font-semibold text-[var(--text)] mb-2">
                <span className="px-2 py-1 rounded-full text-sm font-medium bg-[var(--secondary)]/10 text-[var(--secondary)] mr-2">v1.1.0</span>
                December 5, 2024
              </h2>
    ...
    return (
      <div className="py-6">
        <div className="text-center">
          <h1 className="text-2xl font-semibold text-[var(--text)] mb-4">Welcome to the Kindred AI Hub Documentation</h1>
          <p className="text-[var(--textSecondary)] mb-6">Select a topic from the sidebar to get started</p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <button 
              onClick={() => setActivePage('introduction')}
              className="p-6 border border-[var(--border)] rounded-lg hover:border-[var(--primary)] hover:bg-[var(--activeNav)]/50 transition-colors"
            >
              <h2 className="text-lg font-medium text-[var(--text)] mb-2">Introduction</h2>
              <p className="text-[var(--textSecondary)] text-sm">Learn about the Kindred AI Hub and how it works</p>
            </button>
            ...
            <button 
              ...
              className="p-6 border border-[var(--border)] rounded-lg hover:border-[var(--primary)] hover:bg-[var(--activeNav)]/50 transition-colors"
            >
              <h2 className="text-lg font-medium text-[var(--text)] mb-2">AI Assistant</h2>
              <p className="text-[var(--textSecondary)] text-sm">Explore the conversation and sentiment analysis APIs</p>
            </button>
            ...
            <button 
              ...
              className="p-6 border border-[var(--border)] rounded-lg hover:border-[var(--primary)] hover:bg-[var(--activeNav)]/50 transition-colors"
            >
              <h2 className="text-lg font-medium text-[var(--text)] mb-2">EQ Assessment</h2>
              <p className="text-[var(--textSecondary)] text-sm">Discover how to measure emotional intelligence</p>
            </button>
          </div>
        </div>
      </div>
  ...
  const renderCodeExample = () => {
    ...
    if (activePage === 'introduction') {
      return (
        <div>
          <div className="bg-[var(--codeBackground)] rounded-t-md p-3">
            <div className="flex items-center">
              <div className="flex-1">
                <h3 className="text-sm font-medium text-[var(--codeText)]">API VERSION HEADER</h3>
              </div>
              <button className="text-[var(--textSecondary)] hover:text-[var(--text)]">
          ...
          <div className="bg-[var(--codeBackground)] p-3 text-sm font-mono">
            <div className="text-[var(--codeText)]">$ curl https://api.kindredai.com/v1/introduction \</div>
            <div className="text-[var(--codeText)]">  -H "Authorization: Bearer sk_test_4eC39HqLyjWDarjtT1zdp7dc"</div>
          </div>
          ...
          <div className="mt-6">
            <div className="bg-[var(--codeBackground)] rounded-t-md p-3">
              <div className="flex items-center">
                <div className="flex-1">
                  <h3 className="text-sm font-medium text-[var(--codeText)]">RESPONSE</h3>
                </div>
                <button className="text-[var(--textSecondary)] hover:text-[var(--text)]">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
            ...
            <div className="bg-[var(--codeBackground)] p-3 rounded-b-md text-sm font-mono">
              <div className="text-[var(--codeText)]">{"{"}</div>
              <div className="text-[var(--codeText)]">  "name": "Kindred AI Hub",</div>
              <div className="text-[var(--codeText)]">  "version": "1.3.0",</div>
              <div className="text-[var(--codeText)]">  "description": "API platform for emotional intelligence integration",</div>
              <div className="text-[var(--codeText)]">  "documentation_url": "https://docs.kindredai.com",</div>
              <div className="text-[var(--codeText)]">  "features": [</div>
              <div className="text-[var(--codeText)]">    "sentiment_analysis",</div>
              <div className="text-[var(--codeText)]">    "eq_assessment",</div>
              <div className="text-[var(--codeText)]">    "emotion_tracking",</div>
              <div className="text-[var(--codeText)]">    "team_insights"</div>
              <div className="text-[var(--codeText)]">  ],</div>
              <div className="text-[var(--codeText)]">  "status": "operational"</div>
              <div className="text-[var(--codeText)]">{"}"}</div>
            </div>
          </div>
        </div>
      ...
      return (
        <div>
          <div className="bg-[var(--codeBackground)] rounded-t-md p-3">
            <div className="flex items-center">
              <div className="flex-1">
                <h3 className="text-sm font-medium text-[var(--codeText)]">AUTHENTICATED REQUEST</h3>
              </div>
              <button className="text-[var(--textSecondary)] hover:text-[var(--text)]">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
          ...
          <div className="bg-[var(--codeBackground)] p-3 text-sm font-mono">
            <div className="text-[var(--codeText)]">$ curl \</div>
            <div className="text-[var(--codeText)]">  -u sk_test_4eC39HqLyjWDarjtT1zdp7dc: \</div>
            <div className="text-[var(--codeText)]">  https://api.kindredai.com/v1/emotion/analyze</div>
          </div>
          
          <div className="bg-[var(--codeBackground)] p-4 rounded-b-md">
            <h3 className="text-sm font-medium text-[var(--codeText)] mb-3">YOUR API KEY</h3>
          ...
          <div className="mt-6">
            ...
            <div className="bg-[var(--codeBackground)] p-3 rounded-b-md text-sm font-mono">
              <div className="text-[var(--codeText)]">{"{"}</div>
              <div className="text-[var(--codeText)]">  "success": true,</div>
              <div className="text-[var(--codeText)]">  "status": "authenticated",</div>
              <div className="text-[var(--codeText)]">  "message": "API key is valid"</div>
              <div className="text-[var(--codeText)]">{"}"}</div>
            </div>
          </div>
        </div>
      ...
      return (
        <div>
          <div className="bg-[var(--codeBackground)] rounded-t-md p-3">
            <div className="flex items-center">
              <div className="flex-1">
                <h3 className="text-sm font-medium text-[var(--codeText)]">CONVERSATION API</h3>
              </div>
              <button className="text-[var(--textSecondary)] hover:text-[var(--text)]">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
          ...
          <div className="bg-[var(--codeBackground)] p-3 text-sm font-mono">
            <div className="text-[var(--codeText)]">$ curl -X POST https://api.kindredai.com/v1/conversation/send \</div>
            <div className="text-[var(--codeText)]">  -H "Authorization: Bearer sk_test_4eC39HqLyjWDarjtT1zdp7dc" \</div>
            <div className="text-[var(--codeText)]">  -H "Content-Type: application/json" \</div>
            <div className="text-[var(--codeText)]">  -d "message": "How can I improve my leadership skills?"</div>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="bg-[var(--codeBackground)] p-3 rounded-b-md text-sm font-mono">
              <div className="text-[var(--codeText)]">{"{"}</div>
              <div className="text-[var(--codeText)]">  "conversation_id": "conv_12345abcde",</div>
              <div className="text-[var(--codeText)]">  "message": "How can I improve my leadership skills?",</div>
              <div className="text-[var(--codeText)]">  "response": "Improving emotional intelligence in leadership starts with self-awareness. Try to regularly reflect on your emotions and how they impact your decisions and interactions with team members. Additionally, practice active listening, seek feedback from your team, and work on empathy by trying to understand others' perspectives. Leadership development is a journey that requires consistent practice and openness to growth.",</div>
              <div className="text-[var(--codeText)]">  "emotional_analysis": </div>
              <div className="text-[var(--codeText)]">    "query_intent": "personal_growth",</div>
              <div className="text-[var(--codeText)]">    "sentiment": "neutral",</div>
              <div className="text-[var(--codeText)]">    "detected_emotions": ["curiosity", "ambition"]</div>
              <div className="text-[var(--codeText)]">  </div>
              <div className="text-[var(--codeText)]">{"}"}</div>
            </div>
          </div>
    ...
    return (
      <div className="p-4 bg-[var(--hoverNav)] text-[var(--textSecondary)] text-center rounded-md">
  ...
  return (
    <div className="w-64 bg-[var(--sidebar)] border-r border-[var(--border)] h-screen overflow-y-auto sticky top-0 sidebar-scrollbar">
      <div className="p-4 border-b border-[var(--border)]">
        ...
        {/* AI Assistant section */}
        <div className="p-4 border-b border-[var(--border)]">
          <h2 className="text-md font-semibold text-[var(--primary)] mb-2">AI Assistant</h2>
          <ul className="space-y-1">
            <li>
              <button
                onClick={() => setActivePage('conversation-api')}
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'conversation-api' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
                Conversation API
              </button>
            </li>
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'user-context' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
                User Context
              </button>
            </li>
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'sentiment-analysis' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
                Sentiment Analysis
              </button>
            </li>
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'response-customization' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
            ...
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'real-time-coaching' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
                Real-Time Coaching
              </button>
            </li>
        ...
        {/* Emotional Intelligence section */}
        <div className="p-4 border-b border-[var(--border)]">
          <h2 className="text-md font-semibold text-[var(--primary)] mb-2">Emotional Intelligence</h2>
          <ul className="space-y-1">
            <li>
              <button
                onClick={() => setActivePage('eq-assessment')}
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'eq-assessment' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
                EQ Assessment
              </button>
            </li>
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'self-awareness' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
            ...
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'social-awareness' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
            ...
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'emotion-tracking' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
                Emotion Tracking
              </button>
            </li>
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'team-leadership' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
        ...
        {/* Core Features section */}
        <div className="p-4 border-b border-[var(--border)]">
          <h2 className="text-md font-semibold text-[var(--primary)] mb-2">Core Features</h2>
          <ul className="space-y-1">
            <li>
              <button
                onClick={() => setActivePage('data-dashboards')}
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'data-dashboards' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
                Data Dashboards
              </button>
            </li>
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'integrations' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
                Integrations
              </button>
            </li>
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'webhooks' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
                Webhooks
              </button>
            </li>
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'settings' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
        ...
        {/* App-Specific APIs section */}
        <div className="p-4 border-b border-[var(--border)]">
          <h2 className="text-md font-semibold text-[var(--primary)] mb-2">App-Specific APIs</h2>
          <ul className="space-y-1">
            <li>
              <button
                onClick={() => setActivePage('goleman')}
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'goleman' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
            ...
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'waitingroom' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
                Waiting Room
              </button>
            </li>
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'medchefs' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
                MedChefs
              </button>
            </li>
        ...
        {/* Developer Tools section */}
        <div className="p-4">
          <h2 className="text-md font-semibold text-[var(--primary)] mb-2">Developer Tools</h2>
          <ul className="space-y-1">
            <li>
              <button
                onClick={() => setActivePage('api-playground')}
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'api-playground' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
                API Playground
              </button>
            </li>
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'sdks' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
            ...
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'code-examples' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
                Code Examples
              </button>
            </li>
            <li>
              <button
                ...
                className={`w-full text-left px-2 py-1 text-sm rounded ${activePage === 'changelog' ? 'bg-[var(--activeNav)] text-[var(--activeNavText)] font-medium' : 'text-[var(--textSecondary)] hover:bg-[var(--hoverNav)]'}`}
              >
                Changelog
              </button>
            </li>
...
return (
  <div className="flex min-h-screen bg-[var(--background)]">
    ...
    <div className="flex-1 overflow-auto">
      <div className="flex">
        <div className="flex-1 p-6 border-r border-[var(--border)] text-[var(--text)]">
          {renderContent()}
        </div>
        
        <div className="w-96 p-6 bg-[var(--sidebar)]">
          <h2 className="text-lg font-semibold text-[var(--primary)] mb-4">Code Examples</h2>
          {renderCodeExample()}
        </div>
      </div>
    </div>
